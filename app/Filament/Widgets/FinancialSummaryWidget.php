...
class FinancialSummaryWidget extends BaseWidget
{
    ...
    protected function getStats(): array
    {
        ...
        $totalPendingFee = $isSuperAdmin
            ? FeeVoucher::whereNotIn('status', ['paid', 'cancelled', 'void'])->sum('balance_amount')
            : FeeVoucher::where('campus_id', $user->campus_id)->whereNotIn('status', ['paid', 'cancelled', 'void'])->sum('balance_amount');
