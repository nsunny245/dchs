...
class GenerateFeeTemplate extends Command
{
    ...
    protected $description = 'Generate a beautifully styled multi-tab Excel template for DCHS fee structures';
    ...
    public function handle(): void
    {
        ...
        foreach ($campuses as $campusIndex => $campus) {
            ...
            $sheet->getStyle('A2')->getFont()->setBold(true)->setSize(12)->setColor(new \PhpOffice\PhpSpreadsheet\Style\Color('0A1526'));
            $sheet->getStyle('A3')->getFont()->setItalic(true)->setSize(10)->setColor(new \PhpOffice\PhpSpreadsheet\Style\Color('556B82'));
