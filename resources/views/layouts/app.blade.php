...
<body class="font-body antialiased bg-brand-surface text-navy-900">
    <!-- Top Bar - Navy Blue -->
    <div class="bg-navy-900 text-white text-xs py-2">
        <div class="container mx-auto px-4 flex flex-col sm:flex-row justify-between items-center gap-2">
            ...
            <div class="flex items-center space-x-3 text-xs">
                <a href="{{ route('filament.admin.auth.login') }}" class="text-gold-500 hover:text-white transition font-medium">Staff Login</a>
                <span class="text-gray-400">|</span>
                <a href="#" class="text-gold-500 hover:text-white transition font-medium">Student Login</a>
            </div>
        </div>
    </div>
    ...
    <nav class="bg-white shadow-md sticky top-0 z-50" x-data="{ mobileMenuOpen: false }">
            ...
            <div class="flex justify-between items-center h-20">
                ...
                <div class="hidden lg:flex items-center space-x-6">
                    ...
                    <div class="relative group" x-data="{ open: false }">
                        ...
                        <div x-show="open" @mouseenter="open = true" @mouseleave="open = false" class="dropdown-menu absolute top-full left-0 mt-0 w-56 bg-white rounded-lg shadow-xl border-t-4 border-gold-500 overflow-hidden">
                            <div class="py-1">
                                <a href="#" class="block px-4 py-2.5 text-sm text-navy-900 hover:bg-navy-50 hover:text-gold-500">Chairman's Message</a>
                                <a href="#" class="block px-4 py-2.5 text-sm text-navy-900 hover:bg-navy-50 hover:text-gold-500">Vision & Mission</a>
                                <a href="#" class="block px-4 py-2.5 text-sm text-navy-900 hover:bg-navy-50 hover:text-gold-500">Accreditation</a>
                                <a href="#" class="block px-4 py-2.5 text-sm text-navy-900 hover:bg-navy-50 hover:text-gold-500">Leadership</a>
                            </div>
                        </div>
                    </div>
                                ...
                                @forelse($globalPrograms as $program)
                                    <a href="{{ route('courses.show', $program->code) }}" class="block px-4 py-2.5 hover:bg-navy-50 border-b border-gray-50 last:border-0">
                                        <div class="flex items-center justify-between">
                                            <span class="font-bold text-gold-700 text-xs">{{ $program->code }}</span>
                                            <span class="text-navy-900 text-xs">{{ $program->name }}</span>
                                        </div>
                                    </a>
                                @empty
                ...
                <!-- Mobile Menu Button -->
                <button @click="mobileMenuOpen = !mobileMenuOpen" class="lg:hidden text-navy-900 p-2">
        ...
        <div x-show="mobileMenuOpen" x-cloak @click.away="mobileMenuOpen = false" class="lg:hidden bg-white border-t shadow-lg">
            <div class="px-4 py-3 space-y-1">
                <a href="{{ route('home') }}" class="block px-3 py-2.5 text-navy-900 hover:bg-navy-50 hover:text-gold-500 rounded font-medium">Home</a>
                <a href="{{ route('campuses') }}" class="block px-3 py-2.5 text-navy-900 hover:bg-navy-50 hover:text-gold-500 rounded font-medium">Campuses</a>
                <a href="{{ route('courses') }}" class="block px-3 py-2.5 text-navy-900 hover:bg-navy-50 hover:text-gold-500 rounded font-medium">Programs</a>
                <a href="{{ route('admissions') }}" class="block px-3 py-2.5 text-navy-900 hover:bg-navy-50 hover:text-gold-500 rounded font-medium">Admissions</a>
                <a href="{{ route('contact') }}" class="block px-3 py-2.5 text-navy-900 hover:bg-navy-50 hover:text-gold-500 rounded font-medium">Contact</a>
                <a href="{{ route('admissions.apply') }}" class="block mt-3 text-center bg-gold-500 text-navy-900 px-4 py-3 rounded-lg font-bold">Apply Now</a>
            </div>
        </div>
    </nav>
    ...
    <footer class="bg-navy-900 text-white pt-16 pb-8">
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
                <div>
                    ...
                    <div class="flex space-x-3">
                        <a href="#" class="w-8 h-8 rounded-full bg-navy-700 flex items-center justify-center hover:bg-gold-500 transition">
                ...
                <div>
                    <h3 class="text-lg font-bold mb-4 text-gold-500 font-display">Quick Links</h3>
                    <ul class="space-y-2 text-sm">
                        <li><a href="#" class="text-gray-300 hover:text-gold-500 transition">About Us</a></li>
                        <li><a href="#" class="text-gray-300 hover:text-gold-500 transition">Programs</a></li>
                        <li><a href="#" class="text-gray-300 hover:text-gold-500 transition">Admissions</a></li>
                        <li><a href="#" class="text-gray-300 hover:text-gold-500 transition">Fee Structure</a></li>
                        <li><a href="#" class="text-gray-300 hover:text-gold-500 transition">Student Portal</a></li>
                    </ul>
                </div>

                <div>
                    <h3 class="text-lg font-bold mb-4 text-gold-500 font-display">Programs</h3>
                    <ul class="space-y-2 text-sm">
                        @foreach($globalPrograms->take(5) as $program)
                            <li><a href="{{ route('courses.show', $program->code) }}" class="text-gray-300 hover:text-gold-500 transition">{{ $program->code }} - {{ $program->name }}</a></li>
                        @endforeach
                    </ul>
                </div>

                <div>
                    <h3 class="text-lg font-bold mb-4 text-gold-500 font-display">Contact</h3>
                    <ul class="space-y-3 text-sm text-gray-300">
                        <li class="flex items-start">
                            <svg class="w-4 h-4 mr-2 text-gold-500 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="border-t border-navy-700 pt-8 flex flex-col md:flex-row justify-between items-center">
                ...
                <div class="flex space-x-6 mt-4 md:mt-0 text-sm text-gray-400">
                    ...
                    <a href="#" class="hover:text-gold-500 transition">Terms</a>
                </div>
            </div>
        </div>
    </footer>
